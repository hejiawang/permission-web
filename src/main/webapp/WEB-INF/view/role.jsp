						...
						<div class="col-xs-12">
							<div class="col-xs-12">
								<div id="elementbut" style="padding-bottom: 10px;">
									<button id="goRaise" onclick="permission.role.goRaise();" class="btn btn-success btn-next" data-last="Finish" style="margin-left:5px;" >新增</button>
							...
							<div class="col-xs-12" style="background-color: #F0F0F0; padding-top: 10px; padding-bottom: 10px;">
							    <input class="input-sm" id="roleNameSerch"  placeholder="查询角色名称"   type="text">
						        <input class="btn btn-info" type="button" value="检索" id="goSearch" onclick="permission.role.goSearch();" style="margin-left: 20px;"/>	
						        <input class="btn btn-info" type="button" value="清空" id="goReset" onclick="permission.role.goReset();" style="margin-left: 20px;"/>
				...
				<div id="dialog-message"  class="hide">
					<form  class="form-horizontal" id="validation-form" role="form" action="">
						<div class="form-group">
							<label class="control-label col-xs-12 col-sm-3  no-padding-right" for="roleName"><span style="color:red">*</span>角色名称:</label>
							<div class="col-sm-9">
								<div class="clearfix">
									<input type="text" id="roleName" name="roleName"  class="col-xs-10 col-sm-3" />
									<span for="roleName" class="help-block" style="color:red;display:none;" id="roleNameSpan">角色名称重复!</span>
								</div>	
							</div>
						</div>
...
<script type="text/javascript" src="<%= basePath%>resources/js/permission/role.js"></script>
<script type="text/javascript">
